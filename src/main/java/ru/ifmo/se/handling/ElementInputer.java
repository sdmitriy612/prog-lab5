...
public class ElementInputer {
     ...
     * @return the created {@link Flat} object
     */
    public Flat inputFlat(StringIOController stringIOController){
