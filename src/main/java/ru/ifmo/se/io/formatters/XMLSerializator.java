...
/**
 * XMLSerializator class serializes {@link CollectionManager} to an XML file.
 * <p>
 *     This class uses Jackson's {@link XmlMapper} to handle XML serialization and deserialization.
 * </p>
 */
public class XMLSerializator implements Serializator<CollectionManager> {
     ...
     */
    public XMLSerializator(String pathToFile){
